...
export const engineerIconSymbol: SvgSymbolDef = {
  id: 'class-icon-engineer',
  viewBox: '0 0 517 1024',
  content: (
    <>
      <path
        fill="currentColor"
...
export default function EngineerIcon({ ...props }: IconProps) {
  return (
    <Icon {...props}>
      <svg viewBox={engineerIconSymbol.viewBox}>
        <use href={`#${engineerIconSymbol.id}`} />
      </svg>
    </Icon>
  );
}
