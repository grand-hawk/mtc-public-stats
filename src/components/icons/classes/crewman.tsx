...
export const crewmanIconSymbol: SvgSymbolDef = {
  id: 'class-icon-crewman',
  viewBox: '0 0 956 1024',
  content: (
    <>
      <path
        fill="currentColor"
...
export default function CrewmanIcon({ ...props }: IconProps) {
  return (
    <Icon {...props}>
      <svg viewBox={crewmanIconSymbol.viewBox}>
        <use href={`#${crewmanIconSymbol.id}`} />
      </svg>
    </Icon>
  );
}
